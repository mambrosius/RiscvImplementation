...
class Control extends Module {
	...
	io.EX.alu_sel 		:= Mux(io.flush, ZERO, io.ctrl.opcode =/= R && io.ctrl.opcode =/= B)
	io.EX.alu_op.alt  	:= Mux(io.flush, ZERO, io.ctrl.funct7(5))
	io.EX.alu_op.func 	:= Mux(io.flush, ZERO, io.ctrl.funct3)
	io.EX.opcode 		:= Mux(io.flush, ZERO, io.ctrl.opcode)	
